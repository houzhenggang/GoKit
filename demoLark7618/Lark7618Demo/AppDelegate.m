...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
     ...
     */
    [ShareSDK registerApp:@"b6682a0d78f7"
        ...
        onConfiguration:^(SSDKPlatformType platformType, NSMutableDictionary *appInfo) {
            switch (platformType) {
             case SSDKPlatformTypeSinaWeibo:
                 ...
                 [appInfo SSDKSetupSinaWeiboByAppKey:@"b6682a0d78f7" appSecret:@"0d0f2b248598785881ca6105d28c6c5a" redirectUri:@"http://www.sharesdk.cn" authType:SSDKAuthTypeBoth];
                 break;
             case SSDKPlatformTypeWechat:
//                 [appInfo SSDKSetupWeChatByAppId:@"wx4868b35061f87885" appSecret:@"64020361b8ec4c99936c0e3999a9f249"];
                 break;
             case SSDKPlatformTypeQQ:
                 [appInfo SSDKSetupQQByAppId:@"b6682a0d78f7" appKey:@"0d0f2b248598785881ca6105d28c6c5a" authType:SSDKAuthTypeBoth];
                 break;
             case SSDKPlatformTypeRenren:
